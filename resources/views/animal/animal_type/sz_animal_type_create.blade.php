          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex align-items-center justify-content-between">
                <div>              
                    <p class="card-description">Dodaj strogo zaštićenu jedinku</p>
                </div>
                <div>
                    <a href="{{ url("/sz_animal_type?type=1") }}" class="btn btn-sm  btn-warning">Pregled svih</a>
                </div>
            </div>
              <form action="{{ route('store_sz_animal_type') }}" method="POST">
                @csrf
        ...
        <div class="col-md-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('create_sz_animal_type_cat') }}" method="POST">
                @csrf
                <div class="form-group">
