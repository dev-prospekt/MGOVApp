...
@section('content') 
    <div class="row">
       ...
       {{--  <div class="col-md-5">
          ...
          <div class="card">
            <div class="card-body">
              <p class="card-description">Dodaj Novi Red</p>
              <form action="{{ route('store_animal_order') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label>Naziv Reda</label>
                ...
                <div class="form-group">
                  <label>Razred</label>
                  <select class="form-control" name="animal_class" id="">     
                ...
                <button type="submit" class="btn btn-primary mr-2 mt-2">Dodaj novi Red</button>
              </form>
            </div>
          </div>
        </div> --}}
