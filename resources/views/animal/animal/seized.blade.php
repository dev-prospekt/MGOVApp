...
<ul class="nav nav-tabs" id="myTab" role="tablist">
    ...
    <li class="nav-item">
        <a class="nav-link" id="predao-tab" data-toggle="tab" href="#predao" role="tab" aria-controls="predao" aria-selected="false">
            Tko je predao životinju
        </a>
    </li>
</ul>
...
<div class="tab-content border border-top-0" id="myTabContent">
    ...
    <div class="tab-pane fade" id="predao" role="tabpanel" aria-labelledby="predao-tab">
        <div class="card">
            <div class="card-body">
