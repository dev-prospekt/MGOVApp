...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('shelter-create', 'Shelter\ShelterController@create')->name('shelter.create');
    ...
    Route::get('shelter{shelter}/animal_group{animalGroup}/another', 'Animal\AnimalGroupController@animalAnotherShelter')->name('animal_item_another_shelter');
    ...
    */
    ...
    Route::post("/podaci-update/{id}", [PodaciController::class, 'podaci_update'])->name('podaci-update');
    Route::delete("/podaci-delete/{id}/{model}", [PodaciController::class, 'podaci_delete'])->name('podaci-delete');
